...
carimg=pygame.image.load('C:/Python_Projects/Car_Racer_Game/car1.jpg')
backgroundpic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/download12.jpg")
yellow_strip=pygame.image.load("C:/Python_Projects/Car_Racer_Game/yellow strip.jpg")
strip=pygame.image.load("C:/Python_Projects/Car_Racer_Game/strip.jpg")
intro_background=pygame.image.load("C:/Python_Projects/Car_Racer_Game/background.jpg")
instruction_background=pygame.image.load("C:/Python_Projects/Car_Racer_Game/background2.jpg")
car_width=56
pause=False
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car.jpg")
    elif obs==1:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car1.jpg")
    elif obs==2:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car2.jpg")
    elif obs==3:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car4.jpg")
    elif obs==4:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car5.jpg")
    elif obs==5:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car6.jpg")
    elif obs==6:
        obs_pic=pygame.image.load("C:/Python_Projects/Car_Racer_Game/car7.jpg")
